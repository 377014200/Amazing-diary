...
export function fnCata(){
  ...
  if(loadStyles.mark != 'load'){
    loadStyles("h6{margin:0;padding:0;}\
	    	.box{position: fixed; left: 10px;top: 60px;font:16px/30px '宋体'; border: 2px solid #ccc;padding: 4px; border-radius:5px;min-width:80px;max-width:118px;overflow:hidden;cursor:default;background:rgba(255, 255, 255, 0.5);}\
	    	...
	    	.box-quitAnother{background:rgba(51, 153, 255, 0.55);left:0;top:0;}\
